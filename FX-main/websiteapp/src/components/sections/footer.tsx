      ...
      <div className="max-w-[1280px] mx-auto px-6 md:px-12 lg:px-20">
          ...
          <div className="flex items-center gap-4">
            ...
            <ul className="flex items-center gap-4">
              <li>
                <a
                  href="#"
                  aria-label=" StockPip on Twitter"
              ...
              <li>
                <a
                  href="#"
                  aria-label=" StockPip on Instagram"
                  className="text-white hover:opacity-75 transition-opacity"
                >
                  <InstagramIcon />
                </a>
              ...
              <li>
                <a
                  href="#"
                  aria-label=" StockPip on LinkedIn"
                  className="text-white hover:opacity-75 transition-opacity"
                >
                  <LinkedinIcon />
                </a>
              ...
              <li>
                <a
                  href="#"
                  aria-label=" StockPip on Youtube"
                  className="text-white hover:opacity-75 transition-opacity"
                >
                  <YoutubeIcon />
                </a>
        ...
        <div className="mt-8 lg:mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-10">
          ...
          <div className="text-xs leading-[1.4] space-y-4 md:col-span-2 lg:col-span-1">
            ...
            <p>
              {" "}
              StockPip is a UK-based fintech company providing forex trading
        ...
        <div className="mt-8 flex flex-col md:flex-row justify-between items-center text-xs gap-4">
          ...
          <a
            href="https://wa.me/919238822465?text=Hello,%20I%20would%20like%20to%20know%20more%20about%20 StockPip%20trading%20platform"
            target="_blank"
