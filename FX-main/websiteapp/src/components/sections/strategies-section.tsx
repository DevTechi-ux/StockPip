            ...
            <div className="max-w-[470px] text-center lg:text-left mx-auto lg:mx-0">
              ...
              <div className="mt-8">
                ...
                <p className="text-sm text-text-secondary mb-4">
                   StockPip empowers financial startups, trading educators, and fintech entrepreneurs to launch their own branded trading platforms instantly — with zero coding and maximum control.
                </p>
                <p className="text-sm text-text-secondary">
                  Join hundreds of businesses already powered by  StockPip technology.
                </p>
              </div>
            </div>
          </div>
