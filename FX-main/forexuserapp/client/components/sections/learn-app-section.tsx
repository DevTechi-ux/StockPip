  ...
  return (
    <section className="flex flex-col bg-[#d4ff00] px-6 py-20 text-black">
      <div className="mx-auto flex w-full max-w-[1200px] flex-col items-center">
        ...
        <a href="#" className="mb-14 inline-flex items-center justify-center rounded-full bg-black px-6 py-[14px] text-sm font-medium text-white transition-transform duration-200 ease-in-out hover:scale-[1.04]">
          Sign up to access StockPip Learn
        </a>
        ...
        <div className="mb-8 w-full max-w-[474px]">
          <img
            ...
            alt="A phone displaying the StockPip Learn interface."
