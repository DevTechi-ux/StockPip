        ...
        <div className="flex flex-col lg:flex-row lg:items-center">
          ...
          <div className="lg:w-[45%] mt-12 lg:mt-0">
            <div className="max-w-md mx-auto lg:mx-0 lg:max-w-none">
              <span className="font-body font-medium text-sm text-[#d4ff00]">Next-Gen Forex Trading Platform</span>
              <h2 className="font-headline text-[40px] text-white font-normal leading-tight mt-6">
                Power your business with StockPip's all-in-one trading technology — built for performance, flexibility, and growth.
              </h2>
              <p className="font-body text-muted-foreground text-lg mt-6">Trade forex, indices, crypto, gold, and commodities with lightning-fast execution and deep liquidity.</p>
              <p className="font-body text-muted-foreground text-sm mt-4">Intuitive dashboards. Real-time charts. AI-backed analytics.</p>
              <div className="mt-6">
